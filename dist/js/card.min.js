...
function drawIt(){var e=$(".sourceElement"),t=parseInt(e.css("width"),10),a=parseInt(e.css("height"),10),n=e.html(),s=document.createElement("canvas");s.width=t,s.height=a,s.id="canvas";var r='<span class="save-card">Right click and "Save Image"</span>';$(".card-output").html(s).append(r);var o=document.getElementById("canvas");$("body").addClass("-drawing-card"),$(".SoB").addClass("-drawing"),rasterizeHTML.drawHTML(n,o).then(function(){$(".SoB").removeClass("-drawing")},function(){console.log("error drawing card"),$("body").removeClass("-drawing-card"),$(".SoB").removeClass("-drawing")})}function initDraggable(){$(".draggable").draggable({containment:"parent"})}function addTextElement(){var e=document.createElement("div");e.className="text draggable ",e.innerHTML='<span class="text__text custom-font-1">plain <span class="-bold">bold</span> <span class="-italic">italic</span> <span class="-underline">underline</span> <span class="-smallcaps">SmallCaps</span></span>',$(e).appendTo(".card-input").draggable()}function formatText(e,t){var a,n,s=t;return e?(a=/\*\*([^\*{2}]*)\*\*/gm,n='<span class="-bold">$1</span>',s=s.replace(a,n)):(a=/<span class="-bold">([^<]*)<\/span>/gm,n="**$1**",s=s.replace(a,n)),e?(a=/\+\+([^\+{2}]*)\+\+/gm,n='<span class="-italic">$1</span>',s=s.replace(a,n)):(a=/<span class="-italic">([^<]*)<\/span>/gm,n="++$1++",s=s.replace(a,n)),e?(a=/\_\_([^\_{2}]*)\_\_/gm,n='<span class="-underline">$1</span>',s=s.replace(a,n)):(a=/<span class="-underline">([^<]*)<\/span>/gm,n="__$1__",s=s.replace(a,n)),e?(a=/\!\!([^\!{2}]*)\!\!/gm,n='<span class="-smallcaps">$1</span>',s=s.replace(a,n)):(a=/<span class="-smallcaps">([^<]*)<\/span>/gm,n="!!$1!!",s=s.replace(a,n)),s}function changeBackground(e){for(var t,a,n,s="prev"!==e,r=$(".card-input"),o="",d=r[0].className.split(/\s+/),i=0;i<d.length;i++)d[i].indexOf("card-background-")>-1&&(o=d[i]);""===o&&(o="card-background-1"),t=parseInt(o.replace(/card\-background\-/gi,""),10),cardCount>1&&(a=t==cardCount?s?1:cardCount-1:s?t+1:1===t?cardCount:t-1),n="card-background-"+a,r.removeClass(o).addClass(n);var c=$(".sourceElement");c.find('[data-js*="cardBackground"]').appendTo("head"),c.append($('[data-js="cardBackground'+a+'"]'))}function appendHelper(e){e.append(theX).append(theMinus).append(thePlus).append(theRotateLeft).append(theRotateRight).append(theWidthSmaller).append(theWidthLarger).append(theBefore).append(theAfter).append(theText).append(theFont).append(theShadow).append(theShadowColor).append(theColor)}function detachHelper(){$(".theHelper").detach()}function init(){initDraggable(),$("body").on("click","#btnDrawit",function(){drawIt()}),$("body").on("click","#btnAddText",function(){addTextElement()}),$("body").on("click","#btnAddImage",function(){$("#file-input").click()}),$("body").on("click","#btnBackgroundPrev",function(){changeBackground("prev")}),$("body").on("click","#btnBackgroundNext",function(){changeBackground("next")}),$("body").on("mouseenter mouseleave keydown",".draggable",function(e){var t=$(e.target),a="";t.hasClass("text")?a="text":t.hasClass("image")&&(a="image"),"mouseenter"===e.type&&0===$(e.currentTarget).find("theX").length&&appendHelper($(e.currentTarget)),"keydown"===e.type&&detachHelper(),"mouseleave"===e.type&&detachHelper()}),document.getElementById("file-input").onchange=function(e){window.URL=window.URL||window.webkitURL;var t=document.createElement("img");t.src=window.URL.createObjectURL(e.target.files[0]),$("<div class='image draggable -noshadow'>").append(t).appendTo(".card-input").draggable(),$(this).val("")},generateCardAssets(),changeBackground()}function generateCardAssets(){for(var e=0,t=0;t<document.styleSheets.length;t++)if(null!==document.styleSheets[t].href&&document.styleSheets[t].href.indexOf("card.css")>-1){var a=document.styleSheets[t].rules||document.styleSheets[t].cssRules;for(var n in a)if("undefined"!=typeof a[n].cssText&&a[n].cssText.indexOf(".card-background-")>-1){e+=1;var s=a[n].cssText.replace(/(url\().*\/(ass)/gim,"$1$2"),r=$('<style type="text/css" data-js="cardBackground'+e+'">'+s+"</style>");if($("head").append(r),e===cardCount)return!1}}}function getRotationDegrees(e){var t,a=e.css("-webkit-transform")||e.css("-moz-transform")||e.css("-ms-transform")||e.css("-o-transform")||e.css("transform");if("none"!==a){var n=a.split("(")[1].split(")")[0].split(","),s=n[0],r=n[1];t=Math.round(Math.atan2(r,s)*(180/Math.PI))}else t=0;return 0>t?t+360:t}var theTextShadowValue="1px 1px 12px COLOR, -1px -1px 12px COLOR, 1px -1px 12px COLOR, -1px 1px 12px COLOR",theImageShadowValue="drop-shadow(5px 5px 5px COLOR)",cardCount=parseInt($("[data-js='sassVariableCardCount']").css("font-size"),10),fontCount=parseInt($("[data-js='sassVariableFontCount']").css("font-size"),10),is_chrome=navigator.userAgent.toLowerCase().indexOf("chrome")>-1,is_firefox=navigator.userAgent.toLowerCase().indexOf("firefox")>-1;$("body").on("click",'[data-js="buttonClose"]',function(){$("body").removeClass("-drawing-card")});var theX=$("<div class='theHelper theX'>X</div>");$("body").on("click",".theX",function(){var e=$(this);e.parent().detach()});var theMinus=$("<div class='theHelper theMinus'>-</div>");$("body").on("click",".theMinus",function(){var e=$(this),t=e.parent().hasClass("text");if(t){var a=e.parent().find("span.text__text"),n=parseInt(a.css("font-size"),10);a.css({"font-size":n-5})}else{var s=e.parent().find("img"),r=parseInt(s.width(),10);s.width(r-10)}});var thePlus=$("<div class='theHelper thePlus'>+</div>");$("body").on("click",".thePlus",function(){var e=$(this),t=e.parent().hasClass("text");if(t){var a=e.parent().find("span.text__text"),n=parseInt(a.css("font-size"),10);a.css({"font-size":n+5})}else{var s=e.parent().find("img"),r=parseInt(s.width(),10);s.width(r+10)}});var theRotateLeft=$("<div class='theHelper theRotateLeft'>L</div>");$("body").on("click",".theRotateLeft",function(){var e,t=$(this),a=t.parent().hasClass("text");e=t.parent().find(a?"span.text__text":"img");var n=parseInt(getRotationDegrees(e),10);e.css({transform:"rotate("+(n-10).toString()+"deg)"})});var theRotateRight=$("<div class='theHelper theRotateRight'>R</div>");$("body").on("click",".theRotateRight",function(){var e,t=$(this),a=t.parent().hasClass("text");e=t.parent().find(a?"span.text__text":"img");var n=parseInt(getRotationDegrees(e),10);e.css({transform:"rotate("+(n+10).toString()+"deg)"})});var theWidthSmaller=$("<div class='theHelper theWidthSmaller'>W-</div>");$("body").on("click",".theWidthSmaller",function(){var e,t=$(this),a=t.parent().hasClass("text");e=t.parent().find(a?"span.text__text":"img");var n=parseInt(e.width(),10);e.css({width:(n-10).toString()+"px"})});var theWidthLarger=$("<div class='theHelper theWidthLarger'>W+</div>");$("body").on("click",".theWidthLarger",function(){var e,t=$(this),a=t.parent().hasClass("text");e=t.parent().find(a?"span.text__text":"img");var n=parseInt(e.width(),10);e.css({width:(n+10).toString()+"px"})});var theBefore=$("<div class='theHelper theBefore'>&laquo;</div>");$("body").on("click",".theBefore",function(){var e=$(this).parent(),t=e.prev();e.insertBefore(t)});var theAfter=$("<div class='theHelper theAfter'>&raquo;</div>");$("body").on("click",".theAfter",function(){var e=$(this).parent(),t=e.next();e.insertAfter(t)});var $hiddenTextSource,theText=$("<div class='theHelper theText'>T</div>");$("body").on("click",".theText",function(){var e=$(this).parent(),t=e.find("span.text__text"),a=formatText(!1,t.html()),n=$("#editText");$hiddenTextSource=t,$("body").addClass("-edit-text"),n.val(a).focus()}),$("body").on("click",'[data-js="buttonSave"]',function(){var e=$("#editText"),t=formatText(!0,e.val());$hiddenTextSource.html(t),e.val(""),$("body").removeClass("-edit-text")}),$("body").on("click",'[data-js="buttonCancel"]',function(){var e=$("#editText");e.val(""),$("body").removeClass("-edit-text")});var theFont=$("<div class='theHelper theFont'>F</div>");$("body").on("click",".theFont",function(){for(var e,t=$(this).parent().find("span.text__text"),a=t[0].className.split(/\s+/),n=0;n<a.length;n++)if(a[n].indexOf("custom-font-")>-1){e=parseInt(a[n].replace(/custom\-font\-/g,""),10);break}var s;s=e===fontCount?1:e+1,t.removeClass("custom-font-"+e),t.addClass("custom-font-"+s)});var theColor=$("<input type='color' name='theColor' class='theHelper theColor' />");$("body").on("change",".theColor",function(){var e=this.value,t=$(this).parent();t.css({color:e})});var theShadow=$("<div class='theHelper theShadow'>s</div>");$("body").on("click",".theShadow",function(){var e,t=($(this),$(this).parent()),a=t.hasClass("text");e=a?"none"===t.find("span.text__text").css("text-shadow"):"none"===t.find("img").css("-webkit-filter")&&"none"===t.find("img").css("filter"),t.toggleClass("-shadow",e),t.toggleClass("-noshadow",!e)});var theShadowColor=$("<input type='color' name='theShadowColor' class='theHelper theShadowColor' />");$("body").on("change",".theShadowColor",function(){var e,t=this.value,a=$(this).parent(),n=a.hasClass("text");n?(e=theTextShadowValue.replace(/COLOR/gm,t),a.find("span.text__text").css({"text-shadow":e})):(e=theImageShadowValue.replace(/COLOR/gm,t),a.find("img").css({filter:e,"-webkit-filter":e}))}),$("body").on("click",function(e){console.log("click target:"+e.target.className)}),$(document).ready(function(){"undefined"!=typeof SVGForeignObjectElement?init():$('<div class="browser-support">Only Chrome & Firefox are Supported</div>').prependTo(".SoB")});