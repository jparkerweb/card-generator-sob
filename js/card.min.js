...
function drawIt(){var e=$(".sourceElement"),t=parseInt(e.css("width"),10),a=parseInt(e.css("height"),10),n=e.html(),r=document.createElement("canvas");r.width=t,r.height=a,r.id="canvas";var s='<span class="save-card">Right click and "Save Image"</span>';$(".card-output").html(r).append(s);var o=document.getElementById("canvas");$(".SoB").addClass("-drawing"),rasterizeHTML.drawHTML(n,o).then(function(){$(".SoB").removeClass("-drawing")},function(){console.log("error"),$(".SoB").removeClass("-drawing")}),console.log("after")}function initDraggable(){$(".draggable").draggable({containment:"parent"})}function addTextElement(){var e=document.createElement("div");e.className="text draggable -noshadow",e.innerHTML="new text",e.contentEditable="true",$(e).appendTo(".card-input").draggable()}function formatText(e,t){var a,n,r=t;return e?(a=/\*\*([^\*{2}]*)\*\*/gm,n='<span class="-bold">$1</span>',r=r.replace(a,n)):(a=/<span class="-bold">([^<]*)<\/span>/gm,n="**$1**",r=r.replace(a,n)),e?(a=/\+\+([^\+{2}]*)\+\+/gm,n='<span class="-italic">$1</span>',r=r.replace(a,n)):(a=/<span class="-italic">([^<]*)<\/span>/gm,n="++$1++",r=r.replace(a,n)),e?(a=/\_\_([^\_{2}]*)\_\_/gm,n='<span class="-underline">$1</span>',r=r.replace(a,n)):(a=/<span class="-underline">([^<]*)<\/span>/gm,n="__$1__",r=r.replace(a,n)),r}function changeBackground(e){for(var t,a,n,r="prev"!==e,s=$(".card-input"),o="",c=s[0].className.split(/\s+/),d=0;d<c.length;d++)c[d].indexOf("card-background-")>-1&&(o=c[d]);""===o&&(o="card-background-1"),t=parseInt(o.replace(/card\-background\-/gi,""),10),cardCount>1&&(a=t==cardCount?r?1:cardCount-1:r?t+1:1===t?cardCount:t-1),n="card-background-"+a,s.removeClass(o).addClass(n);var i=$(".sourceElement");i.find('[data-js*="cardBackground"]').appendTo("head"),i.append($('[data-js="cardBackground'+a+'"]'))}function appendHelper(e){e.append(theX).append(theMinus).append(thePlus).append(theRotateLeft).append(theRotateRight).append(theShadow).append(theShadowColor).append(theColor).append(theBefore).append(theAfter)}function detachHelper(){$(".theHelper").detach()}function init(){initDraggable(),$("body").on("click","#btnDrawit",function(){drawIt()}),$("body").on("click","#btnAddText",function(){addTextElement()}),$("body").on("click","#btnAddImage",function(){$("#file-input").click()}),$("body").on("click","#btnBackgroundPrev",function(){changeBackground("prev")}),$("body").on("click","#btnBackgroundNext",function(){changeBackground("next")}),$("body").on("mouseenter mouseleave keydown",".draggable",function(e){var t=$(e.target),a="";t.hasClass("text")?a="text":t.hasClass("image")&&(a="image"),"mouseenter"===e.type&&(0===$(e.currentTarget).find("theX").length&&appendHelper($(e.currentTarget)),"text"===a&&t.attr({contenteditable:"true"}),t=$(e.target),t.hasClass("text")&&t.html(formatText(!1,t.html()))),"keydown"===e.type&&detachHelper(),"mouseleave"===e.type&&(detachHelper(),"text"===a&&t.attr({contenteditable:"false"}),t.hasClass("text")&&t.html(formatText(!0,t.html())))}),document.getElementById("file-input").onchange=function(e){window.URL=window.URL||window.webkitURL;var t=document.createElement("img");t.src=window.URL.createObjectURL(e.target.files[0]),$("<div class='image draggable -noshadow'>").append(t).appendTo(".card-input").draggable(),$(this).val("")},generateCardAssets(),changeBackground()}function generateCardAssets(){for(var e=0,t=0;t<document.styleSheets.length;t++)if(null!==document.styleSheets[t].href&&document.styleSheets[t].href.indexOf("card.css")>-1){var a=document.styleSheets[t].rules||document.styleSheets[t].cssRules;for(var n in a)if("undefined"!=typeof a[n].cssText&&a[n].cssText.indexOf(".card-background-")>-1){e+=1;var r=a[n].cssText.replace(/(url\().*\/(ass)/gim,"$1$2"),s=$('<style type="text/css" data-js="cardBackground'+e+'">'+r+"</style>");if($("head").append(s),e===cardCount)return!1}}}function getRotationDegrees(e){var t,a=e.css("-webkit-transform")||e.css("-moz-transform")||e.css("-ms-transform")||e.css("-o-transform")||e.css("transform");if("none"!==a){var n=a.split("(")[1].split(")")[0].split(","),r=n[0],s=n[1];t=Math.round(Math.atan2(s,r)*(180/Math.PI))}else t=0;return 0>t?t+360:t}var theTextShadowValue="1px 1px 12px COLOR, -1px -1px 12px COLOR, 1px -1px 12px COLOR, -1px 1px 12px COLOR",theImageShadowValue="drop-shadow(5px 5px 5px COLOR)",cardCount=parseInt($("[data-js='sassVariableCardCount']").css("font-size"),10),theX=$("<div class='theHelper theX'>X</div>");$("body").on("click",".theX",function(){var e=$(this);e.parent().detach()});var theMinus=$("<div class='theHelper theMinus'>-</div>");$("body").on("click",".theMinus",function(){var e=$(this),t=e.parent().hasClass("text");if(t){var a=parseInt(e.parent().css("font-size"),10);e.parent().css({"font-size":a-5})}else{var n=e.parent().find("img"),r=parseInt(n.width(),10);n.width(r-10)}});var thePlus=$("<div class='theHelper thePlus'>+</div>");$("body").on("click",".thePlus",function(){var e=$(this),t=e.parent().hasClass("text");if(t){var a=parseInt(e.parent().css("font-size"),10);e.parent().css({"font-size":a+5})}else{var n=e.parent().find("img"),r=parseInt(n.width(),10);n.width(r+10)}});var theRotateLeft=$("<div class='theHelper theRotateLeft'>L</div>");$("body").on("click",".theRotateLeft",function(){console.log("WTF");var e=$(this),t=e.parent(),a=parseInt(getRotationDegrees(t),10);console.log("currentRotate: "+a),t.css({transform:"rotate("+(a-10).toString()+"deg)"})});var theRotateRight=$("<div class='theHelper theRotateRight'>R</div>");$("body").on("click",".theRotateRight",function(){console.log("WTF");var e=$(this),t=e.parent(),a=parseInt(getRotationDegrees(t),10);console.log("currentRotate: "+a),t.css({transform:"rotate("+(a+10).toString()+"deg)"})});var theBefore=$("<div class='theHelper theBefore'>&laquo;</div>");$("body").on("click",".theBefore",function(){var e=$(this).parent(),t=e.prev();e.insertBefore(t)});var theAfter=$("<div class='theHelper theAfter'>&raquo;</div>");$("body").on("click",".theAfter",function(){var e=$(this).parent(),t=e.next();e.insertAfter(t)});var theColor=$("<input type='color' name='theColor' class='theHelper theColor' />");$("body").on("change",".theColor",function(){var e=this.value,t=$(this).parent();t.css({color:e})});var theShadowColor=$("<input type='color' name='theShadowColor' class='theHelper theShadowColor' />");$("body").on("change",".theShadowColor",function(){var e,t=this.value,a=$(this).parent(),n=a.hasClass("text");n?(e=theTextShadowValue.replace(/COLOR/gm,t),a.css({"text-shadow":e})):(e=theImageShadowValue.replace(/COLOR/gm,t),a.find("img").css({filter:e,"-webkit-filter":e}))});var theShadow=$("<div class='theHelper theShadow'>s</div>");$("body").on("click",".theShadow",function(){var e,t=($(this),$(this).parent()),a=t.hasClass("text");e=a?"none"===t.css("text-shadow"):"none"===t.find("img").css("-webkit-filter")&&"none"===t.find("img").css("filter"),t.toggleClass("-shadow",e),t.toggleClass("-noshadow",!e)}),$("body").on("click",function(e){console.log("click target:"+e.target.className)}),$(document).ready(function(){init()});